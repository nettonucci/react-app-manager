...
const VideosToolbar = ({ createVideo }) => {
		...
		<div className={classes.root}>
			...
			>
					...
					>
						...
						<Grid item lg={12} md={6} xl={6} xs={6}>
							...
							{video_url === '' ? (
								...
								<ReactPlayer heigth="100" url={video_url} width="100%" />
							)}
						</Grid>
					</Grid>
				</DialogContent>
				<DialogActions>
					...
					<Button color="primary" onClick={handleAddVideo}>
						Adicionar
					</Button>
				</DialogActions>
			</Dialog>
...
export default connect(null, mapDispatchToProps)(VideosToolbar);
